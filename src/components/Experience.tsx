  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="ml-12 p-6 rounded-lg bg-gradient-to-br from-gray-900/30 to-black/30 border border-gray-800/50 backdrop-blur-sm
                   shadow-[0_0_15px_rgba(106,17,203,0.1)] hover:shadow-[0_0_20px_rgba(106,17,203,0.2)] transition-all duration-300
                   hover:border-[#2575fc]/30"
      >
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
          ...
          <div className="px-4 py-1 rounded-full bg-gradient-to-br from-[#6a11cb]/10 to-[#2575fc]/10 
                          border border-[#6a11cb]/20 shadow-[0_0_10px_rgba(106,17,203,0.1)]
                          text-gray-200 mt-2 sm:mt-0 font-medium">
            {date}
          </div>
        </div>
        <motion.ul 
...
export default function Experience() {
  ...
  return (
    <section id="experience" className="py-20 bg-gradient-to-br from-gray-900/50 to-black backdrop-blur-sm">
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto relative before:absolute before:inset-0 before:bg-gradient-to-b before:from-gray-900/30 before:to-black/30 before:backdrop-blur-md before:-z-10">
